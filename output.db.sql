...
CREATE TABLE IF NOT EXISTS `appendix_b_p2_conversion`(
	...
	`critical_semi-quantitative`	REAL,
	`moderate_semi-quantitative`	REAL,
	`minor_semi-quantitative`	REAL,
...
INSERT INTO `Appendix C - P1` (`hs_id`,`hazardous_situation`,`selected_p1_rationale`,`p1_predicted_by_subject_matter_expertise`,`p1`,`data_summary_derived_p1`,`ucl`,`ucl_value_for_each_plants`) VALUES ('HS.PIT.1.4','Air or gas is administered to the patient (> 4nL to <= 1 mL)',NULL,NULL,1,1.0,NULL,NULL),
...
INSERT INTO `Appendix B - P2 Conversion` (`hazardous_situation_id`,`critical_qualitative`,`moderate_qualitative`,`minor_qualitative`,`critical_semi-quantitative`,`moderate_semi-quantitative`,`minor_semi-quantitative`,`propability_of_hazardous_situation_(p1)`,`critical`,`moderate`,`minor`,`critical.1`,`moderate.1`,`minor.1`) VALUES ('HS.PIT.1.4','Exceptional','Rare','Expected',1.0,2.0,7.0,1.0,1.0,2.0,7.0,'Medium','Low','Low'),
